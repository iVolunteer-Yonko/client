    ...
    <section className="bg-gray-50 py-20">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <p className="text-lg sm:text-xl text-gray-600 mb-12">
          We are a passionate group of individuals working together to bring
          positive change through the Volunteer Connect platform.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-12">
          ...
          <div className="w-64 text-center bg-white rounded-lg shadow-xl p-6">
            <img
              src="/images/roshan-profile.jpeg" // Replace with actual image path
              alt="Roshan Pandey"
          ...
          <div className="w-64 text-center bg-white rounded-lg shadow-xl p-6">
            <img
              src="/images/ranish-profile.jpeg" // Root-relative path for public assets
              alt="Ranish Ghimire"
              className="w-32 h-32 rounded-full mx-auto mb-4 object-cover"
            />
          ...
          <div className="w-64 text-center bg-white rounded-lg shadow-xl p-6">
            <img
              src="/images/rujan-profile.jpeg" // Replace with actual image path
              alt="Rujan Bastola"
              className="w-32 h-32 rounded-full mx-auto mb-4 object-cover"
            />
            <h3 className="text-xl font-semibold text-gray-800">
          ...
          <div className="w-64 text-center bg-white rounded-lg shadow-xl p-6">
            <img
              src="/images/sujal-profile.jpeg" // Replace with actual image path
              alt="Sujal Sangraula"
              className="w-32 h-32 rounded-full mx-auto mb-4 object-cover"
            />
            <h3 className="text-xl font-semibold text-gray-800">
